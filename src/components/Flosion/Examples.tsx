        ...
        <Section header={<h2>Basic Setups</h2>}>
            ...
            <SubSection>
                <p>
                    ...
                    function of the phase, the user can create any wave form they choose. The wave
            ...
            <SubSection>
                <p>
                    ...
                    needs to do when its notes overlap in time. The Sampler object also exposes a
                    "note frequency" number output, which simply yields the value of the current
                    note's frequency. By plugging this into the NoteGen's frequency input, it
                    produces a note of the desired pitch. This example thus plays a sine-wave melody
