    ...
    <>
        ...
        <Section header={<h2>Overview</h2>}>
            ...
            <SubSection>
                ...
                <p>
                    Some numbers in Flosion come from sources that have no state, such as constants,
                    or functions whose inputs are all constants. These can be referred to as global,
                    and they can be used as inputs anywhere. But some numbers come for sources that
                    are stateful, and these are usually sound objects. To preserve the flow of
                    information, stateful number sources cannot be connected to number inputs that
                    don't have access to that state. Again, the flow of numbers needs to be in the
                    direction opposite to the flow of sound. The way that sound is flowing is what
